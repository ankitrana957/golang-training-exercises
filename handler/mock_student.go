...
func (m *MockstudentEnrollmentService) GetSubs(rollNo string) ([]string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockstudentEnrollmentServiceMockRecorder) GetSubs(rollNo interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetSubs", reflect.TypeOf((*MockstudentEnrollmentService)(nil).GetSubs), rollNo)
}
